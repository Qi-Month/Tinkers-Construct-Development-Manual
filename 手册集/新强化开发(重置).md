...
<summary>模块对象<code>type</code>表</summary>

| `type`对应值 | 描述 | 
|:-------------:|:---:|
|tconstruct:constant_enchantment|[赋予附魔](#constant_enchantment)|
|tconstruct:conditional_melee_damage|近战伤害修正|

</details>

* <span id = "constant_enchantment">赋予附魔（"tconstruct:constant_enchantment"）</span>
